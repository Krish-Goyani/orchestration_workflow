...
{{
    ...
    tool_call_requires: "if you want to call the tool than set it as true otherwise false",
    ...
    action_input: "Input for the tool that will take by the tool if you decide to call the tool than and than only otherwise leave it empty just for exmple : {{'location': 'London'}}",
